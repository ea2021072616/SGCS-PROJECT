                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    @foreach($elementos as $elemento)
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 align-middle">
                                                <div class="flex gap-2">
                                                    <a href="{{ route('proyectos.elementos.relaciones.index', [$proyecto, $elemento]) }}" class="btn btn-sm btn-ghost text-black border border-black hover:bg-transparent hover:text-black" title="Relaciones">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"></path>
                                                        </svg>
                                                    </a>
                                                    <a href="{{ route('proyectos.elementos.review', [$proyecto, $elemento]) }}" class="btn btn-sm btn-ghost text-black border border-black hover:bg-transparent hover:text-black" title="Revisar/Aprobar">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                        </svg>
                                                    </a>
                                                    <a href="{{ route('proyectos.elementos.edit', [$proyecto, $elemento]) }}" class="btn btn-sm btn-ghost text-black border border-black hover:bg-transparent hover:text-black" title="Editar">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <form action="{{ route('proyectos.elementos.destroy', [$proyecto, $elemento]) }}" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar este elemento de configuración?');">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-sm btn-ghost text-red-600 border border-red-300 hover:bg-red-50 hover:text-red-700" title="Eliminar">
                                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
